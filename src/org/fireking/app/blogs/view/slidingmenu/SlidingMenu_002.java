...
public class SlidingMenu_002 extends HorizontalScrollView {
	...
	public SlidingMenu_002(Context context, AttributeSet attrs, int defStyleAttr) {
	...
	public SlidingMenu_002(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public SlidingMenu_002(Context context) {
		this(context, null);
	}
	...
	protected void onScrollChanged(int l, int t, int oldl, int oldt) {
		...
		float scale = 1.0f * l / mMenuWidtth; // 1~0
		ViewHelper.setTranslationX(mMenu, scale * mMenuWidtth);
	}
